<?php
/*
* Template Name: Página de Roller Shutter 2
*/
 ?>
...
<section class="hero single-product__hero hero__roller" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__roller">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/roller/roller-device.jpg" alt="<?php echo the_title(); ?>" class="img-responsive">
        </div>
      </div>
      ...
      <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_shades.svg" alt="">
            <p>Cortinas de interior</p>
          </a>
        </div>

        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_blinds.svg" alt="">
            <p>Cortinas roller</p>
          </a>
        </div>
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_curtains.svg" alt="">
            <p>Persianas</p>
          </a>
        </div>
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_window.svg" alt="">
            <p>Ventanas</p>
          </a>
        </div>
