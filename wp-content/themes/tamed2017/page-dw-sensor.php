<?php
/*
* Template Name: Página de DW Sensor
*/
 ?>
...
//$product_acf_id = 30370; // Con el id busca el producto en la página de los plugins
...
<section class="hero single-product__hero hero__dw-sensor" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__dw-sensor">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/dw-sensor/dw-sensor-right.jpg" alt="DW Sensor" class="img-responsive">
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="single-product__content">
          ...
          <p class="text-center" style="text-align:center!important;">
            <a href="#" class="lead btn btn-lg btn-fibaro btn-tienda"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_cart_wtb.svg" alt="Shopping Cart" width="30" height="30">Ver en la Tienda</a>
          </p>
          <?php } ?>
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_door.svg" width="30" height="30" alt="Door" style="margin: 1rem auto;">
                    <p>Sensor de contacto</p>
                </a>
            </div>

            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_lock.svg" alt="">
                    <p>Protección contra manipulaciones</p>
                </a>
            </div>
            ...
            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    ...
                    <p>Un elemento de sistema de seguridad</p>
                </a>
            </div>
        </div>
    </div>
 ...
 <section class="single-product__video">
   ...
   <div class="container-fluid">
     ...
     <?php } ?>
       ...
       <div class="col-xs-12">
         <p class="text-center">
           <a href="#" class="button button-play" id="play-dw-sensor"><span>Play</span></a>
         </p>
       </div>
     </div>
   </div>
...
<?php $manual = get_field('manual_del_producto', $product_acf_id); ?>
<?php if ( !empty($manual)) { ?>
