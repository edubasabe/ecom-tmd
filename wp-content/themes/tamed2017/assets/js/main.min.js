...
/* Crear una cookie */
function setCookie() {
  console.log('Antes de Setear');
 document.cookie = "Subscripcion=Realizada";
 console.log('DEspues de setear');
}

function setLocalStorage() {
  localStorage.setItem('subscribe','tamed_newsletter');
}
...
function getLocalStorage() {
  return localStorage.getItem('subscribe');
}
...
function singleProductsModalVideo() {
    $('.single-product__video .button-play').on('click', function(e) {
      e.preventDefault();
      $('#video-modal').modal('show');
    });
}

singleProductsModalVideo();
...
// calcularPaddingNav('.nav.navbar-nav > li');
...
function fadeElementOffset(element, animation, offsetvalue) {
 ...
 //-- Si no hay cookie de subscripción ------------------------------------------
 var storage = localStorage.getItem('subscribe');
 if ( storage !== "tamed_newsletter" ) {
   console.log('No está subscrito');
...
//-- Cookies -------------------------------------------------------------------
 ...
 if ( myCookie !== "Realizada" || storage !== "tamed_newsletter" ) {
...
function videoProducto() {
  var btnVideoShutter = $('.single-product__video');
  var modalVideo = $('#modal-video');
  btnVideoShutter.on('click', function() {
...
/* Video Homepage */
var videoPromocional = new Modal('#play-promo-video','#video-modal-default', 'https://www.youtube.com/embed/PGL-CZEUOG0');

/* Página Compatibilidad */
var alexa = new Modal('#play-alexa', '#video-modal-default', 'https://www.youtube.com/embed/hrgbHUni-z0');
var todoEstaConectado = new Modal('#todo-conectado', '#video-modal-default', 'https://www.youtube.com/embed/ou2TdFWOMc4');


//-- Videos Productos ----------------------------------------------------------
/* Sensores */
// var motionSensor = new Modal('#play-motion-sensor', '#video-modal', 'https://www.youtube.com/embed/7xgAbxXuZos');
// var floodSensor = new Modal('#play-flood-sensor', '#video-modal', 'https://www.youtube.com/embed/_Lyoc8YHuxQ');
// var dwSensor = new Modal('#play-dw-sensor', '#video-modal', 'https://www.youtube.com/embed/LBA0XxHFJak');
// var smokeSensor = new Modal('#play-smoke-sensor', '#video-modal', 'https://www.youtube.com/embed/z5HFTh4W3nc');
// var cOsensor = new Modal('#play-co-sensor', '#video-modal', 'https://www.youtube.com/embed/EMge0LSmxuM');
// var universalSensor = new Modal('#play-universal-sensor', '#video-modal', 'https://www.youtube.com/embed/GNGRcIofSTI');
//
// /* Actuadores */
// var wallPlug = new Modal('#play-wallplug', '#video-modal', 'https://www.youtube.com/embed/VHG5i_dndvk');
// var dimmer2 = new Modal('#play-dimmer-video', '#video-modal', 'https://www.youtube.com/embed/GNGRcIofSTI');
// var switches2 = new Modal('#play-modulos-video', '#video-modal', 'https://www.youtube.com/embed/GNGRcIofSTI');
// var rollerShutter2 = new Modal('#play-modulos-video', '#video-modal', 'https://www.youtube.com/embed/GNGRcIofSTI');
// var rgbwController = new Modal('#play-modulos-video', '#video-modal', 'https://www.youtube.com/embed/GNGRcIofSTI');
//
// /* Actuadores Remotos */
// var keyfob = new Modal('#play-keyfob', '#video-modal', 'https://www.youtube.com/embed/');
// var button = new Modal('#play-button', '#video-modal', 'https://www.youtube.com/embed/');
// var swipe = new Modal('#play-swipe', '#video-modal', 'https://www.youtube.com/embed/');
//
// /* Controladores */
// var hcl = new Modal('#play-hcl', '#video-modal', 'https://www.youtube.com/embed/');
// var hc2 = new Modal('#play-hc2', '#video-modal', 'https://www.youtube.com/embed/');
...
$(document).on('click', '#mira-los-productos', function (event) {
  event.preventDefault();

  if (!isMobile()) {
    $('#productos').click();
  } else {
    $('button.navbar-toggle.fixed-left').click();
    $('#productos').click();
  }
});
...
//-- Si es Firefox Cambiar coordenadas de PUGINS INTELIGENTES
  if ( is_Firefox() ) {
    $('.compatibilidad__plugins svg text > tspan:first-child').attr('dy','70%');
  }

  //-- Esconder en Mobile
  $('#menu-item-30379').addClass('hidden-xs hidden-sm');

  //-- Insertar onSale before the product title
  // $('#onsale').insertAfter($('#onsale').next());

$('#menu-item-30382 a').attr('target','_blank');
