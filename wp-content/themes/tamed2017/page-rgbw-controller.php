<?php
/*
* Template Name: Página de RGBW Controller
*/
 ?>
...
<section class="hero single-product__hero hero__rgbw-controller" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__rgbw-controller">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/rgbw/rgbw-device.jpg" alt="<?php echo the_title(); ?>" class="img-responsive">
        </div>
      </div>
      ...
      <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_rgb.svg" alt="">
            <p>LED, RGB, RGBW</p>
          </a>
        </div>
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_output.svg" alt="">
            <p>Cuatro canales de salidas</p>
          </a>
        </div>
