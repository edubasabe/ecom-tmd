<!-- Telcos modal on click -->
<div id="telcos-modal-form" class="modal fade">
  <div class="modal-dialog" style="max-width:414px;">
    <div class="modal-content">
      <div class="modal-header">
        <img src="http://nueva.tuhogarinteligente.cl/wp-content/themes/tamed2017/assets/images/logo/tamed-logo-2017.svg" height="20" alt="TAMED">
      ...
      <div class="modal-body">
        <h3 class="text-center">Comuníquese con nosotros</h3>
        <p class="lead text-center">y desarrollemos juntos su proyecto Smarthome</p>
