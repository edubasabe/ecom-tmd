              ...
              <!-- <div class="container">
                <div class="row menu-superior">
                  <div class="hidden-xs col-sm-4 col-md-4">
                    <p class="btn-sm"><i class="fa fa-phone">&nbsp;</i><a href="tel:+56228486547">(+56) 22 848 65 47</a></p>
                  </div>
                  <div class="hidden-xs col-sm-4 col-md-4">
                    <p class="btn-sm text-center"><i class="fa fa-envelope-o">&nbsp;</i><a href="mailto:contacto@tamed.cl">contacto@tamed.cl</a></p>
                  </div>
