...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php bloginfo(stylesheet_directory); ?>/assets/css/master.min.css">
    <!--[if lt IE 9]>
            ...
            <div class="col-sm-12">
              <div class="navbar-header page-scroll">
                <a class="navbar-brand page-scroll navbar__logo-text navbar-icon-center" href="#page-top">
                  <img src="<?php echo get_template_directory(); ?>/assets/images/logo/tamed-2017-blanco-sl.svg" alt="TAMED" class="white-logo">
                </a>
