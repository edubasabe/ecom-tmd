<?php
/*
* Template Name: Página de Flood Sensor
*/
 ?>
...
// $product_acf_id = 30365; // Con el id busca el producto en la página de los plugins
...
<section class="hero single-product__hero hero__flood-sensor" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__flood-sensor">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/flood-sensor/flood-sensor-right.png" alt="Flood Sensor" class="img-responsive">
        </div>
      </div>
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_wireless-1.svg" alt="Door">
 ...
 <section class="single-product__video">
   ...
   <div class="container-fluid">
     ...
     <?php } ?>
       ...
       <div class="col-xs-12">
         <p class="text-center">
           <a href="#" class="button button-play" id="play-motion-sensor"><span>Play</span></a>
         </p>
       </div>
     </div>
   </div>
