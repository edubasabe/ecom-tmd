<?php
/*
* Template Name: Página de Universal Binary Sensor
*/
 ?>
...
//$product_acf_id = 30383; // Con el id busca el producto en la página de los plugins
...
<section class="hero single-product__hero hero__ubs" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/universal-sensor/ubs-device.jpg" alt="<?php echo the_title(); ?>" class="img-responsive">
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        ...
        <div class="col-xs-6 col-sm-4">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon_sensors.svg" alt="">
 ...
 <section class="single-product__video">
   ...
   <div class="container-fluid">
     ...
     <?php } ?>
       ...
       <div class="col-xs-12">
         <p class="text-center">
           <a href="#" class="button button-play" id="play-<?php echo $link_producto_ecommerce; ?>"><span>Play</span></a>
         </p>
       </div>
     </div>
   </div>
