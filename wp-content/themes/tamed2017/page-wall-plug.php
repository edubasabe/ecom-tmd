<?php
/*
* Template Name: Página de Wall Plug
*/
 ?>
...
// $product_acf_id = 30376; // Con el id busca el producto en la página de los plugins
...
<section class="hero single-product__hero hero__wall-plug" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__wall-plug">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/motion-sensor/motion-sensor-right.png" alt="Motion Sensor" class="img-responsive">
        </div>
      </div>
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    ...
                    <p>Monitor de energía</p><br>
                </a>
            </div>

            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon-power-consumption.svg"  width="70" height="70" alt="">
                    <p>Medida de potencia</p>
                </a>
            </div>

            <div class="col-xs-6 col-sm-3">
                <a href="#" class="thumbnail">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon-surge-protection.svg" width="60" height="60" style="margin: .5rem auto;" alt="">
                    <p>Protección al sobrevoltaje</p>
                </a>
            </div>
        </div>
    </div>
