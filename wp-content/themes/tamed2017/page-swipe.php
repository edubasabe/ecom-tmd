...
<section class="hero single-product__hero hero__swipe" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__swipe">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/swipe/swipe-right-2.jpg" alt="<?php echo the_title(); ?>" class="img-responsive">
        </div>
      </div>
