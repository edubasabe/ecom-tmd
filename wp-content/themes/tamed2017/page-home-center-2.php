<?php
/*
* Template Name: Página de Home Center 2
*/
 ?>
...
<section class="hero single-product__hero hero__hc2" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-product__image">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/products/hc2/hc2-device.jpg" alt="<?php echo the_title(); ?>" class="img-responsive">
        </div>
      </div>
