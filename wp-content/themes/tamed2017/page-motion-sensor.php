<?php
/*
* Template Name: Página de Motion Sensor
*/
 ?>
...
<section class="hero single-product__hero hero__motion-sensor" style="background:url(<?php $hero_image['url']; ?>) no-repeat;">
 <?php } else { ?>
 <section class="hero single-product__hero hero__motion-sensor">
 <?php } ?>
 <div class="container">
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon-move.svg" style="margin:5px auto;" alt="">
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon-light-sensor.svg" style="margin: 10px auto;" alt="">
            <p>Sensor de luz</p> <br>
          </a>
        </div>
        ...
        <div class="col-xs-6 col-sm-3">
          <a href="#" class="thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/icon-accelerometer.svg" style="margin:5px auto;" alt="">
            <p>Acelerómetro</p>
          </a>
        </div>
      </div>
